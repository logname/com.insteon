...
<html lang="en">
<head>
    <title>Code coverage report for Insteon\X10.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">Insteon/</a> X10.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
&nbsp;
X10.prototype.cancelPending = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  this.insteon.cancelPending(this.id);</span>
};
&nbsp;
&nbsp;
module.exports = X10;</pre></td></tr>
</table></pre>
