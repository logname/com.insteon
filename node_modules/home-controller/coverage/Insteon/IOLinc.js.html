...
<html lang="en">
<head>
    <title>Code coverage report for Insteon\IOLinc.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">Insteon/</a> IOLinc.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span></td><td class="text"><pre class="prettyprint lang-js">var Q = require('q');
...
&nbsp;
  ...
  deferred.resolve(
    ...
    .then(function (status) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if(!status || !status.response || !status.response.standard) {
<span class="cstat-no" title="statement not covered" >        debug('No response for IO Linc Relay request for device %s', id);</span>
      } else {
    ...
    .then(function (status) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if(!status || !status.response || !status.response.standard) {
<span class="cstat-no" title="statement not covered" >        debug('No response for IO Linc Sensor request for device %s', id);</span>
      } else {
...
&nbsp;
  switch (cmd1 + group) {
<span class="branch-0 cbranch-no" title="branch not covered" >  case '110':</span>
<span class="cstat-no" title="statement not covered" >    this.emit('relayOn', group);</span>
...
<span class="cstat-no" title="statement not covered" >    debug('No event for command - %s', cmd1);</span>
  }
};
&nbsp;
IOLinc.prototype.handleAck = function (cmd1, cmd2) {
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if(!this.emitOnAck) {
...
&nbsp;
&nbsp;
IOLinc.prototype.cancelPending = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  this.insteon.cancelPending(this.id);</span>
};
&nbsp;
&nbsp;
module.exports = IOLinc;</pre></td></tr>
</table></pre>
