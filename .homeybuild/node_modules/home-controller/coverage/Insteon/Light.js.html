...
<html lang="en">
<head>
    <title>Code coverage report for Insteon\Light.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">Insteon/</a> Light.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.61% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>228/236</span>
      </div>
      <div class='fl pad1y space-right2'>
...
482
483
484</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
  if(!!this.insteon &amp;&amp; !!this.insteon.status &amp;&amp; !!this.insteon.status.command) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (command.cmd1 === '19') {
      // ack for light status/level
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if(command.extended &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >       command.cmd1 === '2E' </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >       command.id.toUpperCase() === this.id)</span> {
      // ack for light.info
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if(command.extended &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >       command.cmd1 === '2F' </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >       command.id.toUpperCase() === this.id)</span> {
...
&nbsp;
  ...
  case '2f': // turnOff at ramp
    this.emit('turnOff', group);
    break;
<span class="branch-7 cbranch-no" title="branch not covered" >  case '15': // brighten</span>
<span class="cstat-no" title="statement not covered" >    this.emit('brightened', group);</span>
<span class="cstat-no" title="statement not covered" >    break;</span>
<span class="branch-8 cbranch-no" title="branch not covered" >  case '16': // dim</span>
<span class="cstat-no" title="statement not covered" >    this.emit('dimmed', group);</span>
<span class="cstat-no" title="statement not covered" >    break;</span>
